...
There is **no charge** for non-commercial research use under an approved  
**Software Transfer Agreement (STA)**.

Please complete the STA form and submit it to:
...
Commercial use requires a licensing agreement through the  
